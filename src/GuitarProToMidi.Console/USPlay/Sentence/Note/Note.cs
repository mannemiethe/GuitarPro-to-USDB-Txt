...
public class Note
{
    ...
    {
        Text = text ?? throw new Exception("Text cannot be null");
    }
    ...
    public void SetStartBeat(int newStartBeat)
    {
        ...
        {
            throw new Exception("StartBeat must be less or equal to EndBeat");
        }
    ...
    public void SetEndBeat(int newEndBeat)
    {
        ...
        {
            throw new Exception("EndBeat must be greater or equal to StartBeat");
        }
    ...
    public void SetStartAndEndBeat(int newStartBeat, int newEndBeat)
    {
        ...
        {
            throw new Exception("StartBeat cannot be greater than EndBeat");
        }
